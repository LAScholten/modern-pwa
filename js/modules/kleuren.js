...
class KleurenManager {
    ...
    getTranslations() {
        return {
            ...
            en: {
                ...
                colors: {
                    blond: 'Light Cream',
                    blondgrijs: 'Creamgray',
                    Grijsblond: 'Graycream',
                    blondrood: 'Creamred',
                    roodblond: 'Redcream',
                    rood: 'Red',
                    roodgrijs: 'Redgray',
            ...
            de: {
                ...
                infoText: 'Dadurch haben we een einheitliche Art und Weise der Farben in der Datenbank.',
                closeBtn: 'Schließen',
                colors: {
                    blond: 'Falben',
    ...
    showModal() {
        ...
        const kleurenData = [
            ...
            { file: 'roodgrijs.jpg', key: 'roodgrijs' },
